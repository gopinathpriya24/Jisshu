...
BOT_TOKEN = environ.get('BOT_TOKEN', '7071481742:AAHuH_zYBra9wsL5Fd0Y8nBxN3IzzanMy9c')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1291610043').split()]
USERNAME = environ.get('USERNAME', "https://t.me/GN08M") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002168059715'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+Rzd_odsTBFgwOTdl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001921446982').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gopinath2483:UHDNewDB@clusternew.f2mfa.mongodb.net/?retryWrites=true&w=majority&appName=ClusterNew")
DATABASE_NAME = environ.get('DATABASE_NAME', "Clusternew")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002168059715'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002168059715'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002168059715'))
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002168059715'))
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "9ef1be4029b84770c41dca7e942eefa219468576")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'instantearn.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "9ef1be4029b84770c41dca7e942eefa219468576")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/2bf5bb32bbc4ee87099d7.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://graph.org/file/2bf5bb32bbc4ee87099d7.jpg')
